...
local function on_entity_settings_pasted(event)
    ...
    if
        event.source and event.source.supports_direction and (event.source.fluidbox and #event.source.fluidbox > 0) and (event.source.prototype.collision_box and event.source.prototype.collision_box.x == event.source.prototype.collision_box.y) and event.destination.supports_direction and (event.destination.fluidbox and #event.destination.fluidbox > 0) and
