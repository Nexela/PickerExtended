...
local function find_orphans(event)
    ...
    local cursor_type = player.cursor_stack.valid_for_read and player.cursor_stack.prototype.place_result and types[player.cursor_stack.prototype.place_result.type]
