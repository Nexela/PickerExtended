...
do --(( naked-rail
    PLANNER:copy('picker-naked-rail'):set_fields {
        ...
        icon = '__PickerExtended__/graphics/nakedrails/naked-rails-icon.png',
    ...
    straight.pictures['rail_endings'].sheets[1].filename = '__PickerExtended__/graphics/nakedrails/rail-endings-transparent.png'
    straight.pictures['rail_endings'].sheets[1].hr_version.filename = '__PickerExtended__/graphics/nakedrails/hr-rail-endings-transparent.png'

    for _, id in ipairs(straight_picture_ids) do
        for _, element in ipairs(naked_subelements) do
            straight.pictures[id[1]][element].filename = string.format('__PickerExtended__/graphics/nakedrails/%s-transparent.png', id[2])
            straight.pictures[id[1]][element].hr_version.filename = string.format('__PickerExtended__/graphics/nakedrails/hr-%s-transparent.png', id[2])
        end
    end --))
    ...
    curved.pictures['rail_endings'].sheets[1].filename = '__PickerExtended__/graphics/nakedrails/rail-endings-transparent.png'
    curved.pictures['rail_endings'].sheets[1].hr_version.filename = '__PickerExtended__/graphics/nakedrails/hr-rail-endings-transparent.png'

    for _, id in ipairs(curved_picture_ids) do
        for _, element in ipairs(naked_subelements) do
            curved.pictures[id[1]][element].filename = string.format('__PickerExtended__/graphics/nakedrails/%s-transparent.png', id[2])
            curved.pictures[id[1]][element].hr_version.filename = string.format('__PickerExtended__/graphics/nakedrails/hr-%s-transparent.png', id[2])
        end
    end --))
end --))
...
do --(( sleepy-rail
    PLANNER:copy('picker-sleepy-rail'):set_fields {
        order = 'a[train-system]-a[train]-z',
        icon = '__PickerExtended__/graphics/nakedrails/sleepers-icon.png',
...
do --(( Selection Tools
    Data {
        ...
        icons = {
            {icon = '__PickerExtended__/graphics/nakedrails/naked-replacer-icon.png'},
            {
